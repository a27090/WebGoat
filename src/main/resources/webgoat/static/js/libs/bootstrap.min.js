...
+function(a) {
    ...
    +function(a) {
        ...
        var b = function(b, c) {
            ...
            "hover" == this.options.pause && this.$element.on("mouseenter", a.on(this.pause, this)).on("mouseleave", a.on(this.cycle, this))
        };
        b.DEFAULTS = {
            interval: 5e3,
            pause: "hover",
            ...
            b.prototype.cycle = function(b) {
                ...
                this.options.interval && !this.paused && (this.interval = setInterval(a.on(this.next, this), this.options.interval)),
                    this
            }
            ,
            ...
            b.prototype.show = function() {
                if (!this.transitioning && !this.$element.hasClass("in")) {
                    ...
                    if (this.$element.trigger(b),
                        ...
                        this.$element.one(a.support.transition.end, a.on(f, this)).emulateTransitionEnd(350)[e](this.$element[0][g])
                    }
                }
            }
            ,
            b.prototype.hide = function() {
                if (!this.transitioning && this.$element.hasClass("in")) {
                    ...
                    if (this.$element.trigger(b),
                        ...
                        return a.support.transition ? void this.$element[c](0).one(a.support.transition.end, a.on(d, this)).emulateTransitionEnd(350) : d.call(this)
                    }
                }
            }
            ,
    ...
    +function(a) {
        ...
        var b = function(b, c) {
            ...
            this.options.remote && this.$element.find(".modal-content").load(this.options.remote, a.on(function() {
        ...
        b.DEFAULTS = {
            ...
            b.prototype.show = function(b) {
                ...
                this.isShown || d.isDefaultPrevented() || (this.isShown = !0,
                    this.escape(),
                    this.$element.on("click.dismiss.bs.modal", '[data-dismiss="modal"]', a.on(this.hide, this)),
            ...
            b.prototype.hide = function(b) {
                ...
                this.isShown && !b.isDefaultPrevented() && (this.isShown = !1,
                    ...
                    a.support.transition && this.$element.hasClass("fade") ? this.$element.one(a.support.transition.end, a.on(this.hideModal, this)).emulateTransitionEnd(300) : this.hideModal())
            }
            ,
            b.prototype.enforceFocus = function() {
                a(document).off("focusin.bs.modal").on("focusin.bs.modal", a.on(function(a) {
                    this.$element[0] === a.target || this.$element.has(a.target).length || this.$element.focus()
                }, this))
            }
            ,
            b.prototype.escape = function() {
                this.isShown && this.options.keyboard ? this.$element.on("keyup.dismiss.bs.modal", a.on(function(a) {
            ...
            b.prototype.backdrop = function(b) {
                ...
                if (this.isShown && this.options.backdrop) {
                    ...
                    if (this.$backdrop = a('<div class="modal-backdrop ' + c + '" />').appendTo(document.body),
                        this.$element.on("click.dismiss.bs.modal", a.on(function(a) {
        ...
        b.DEFAULTS = {
            ...
            b.prototype.init = function(b, c, d) {
                ...
                for (var e = this.options.trigger.split(" "), f = e.length; f--; ) {
                    var g = e[f];
                    if ("click" == g)
                        this.$element.on("click." + this.type, this.options.selector, a.on(this.toggle, this));
                    else if ("manual" != g) {
                        var h = "hover" == g ? "mouseenter" : "focusin"
                            , i = "hover" == g ? "mouseleave" : "focusout";
                        this.$element.on(h + "." + this.type, this.options.selector, a.on(this.enter, this)),
                            this.$element.on(i + "." + this.type, this.options.selector, a.on(this.leave, this))
                    }
                }
    ...
    +function(a) {
        "use strict";
        function b(c, d) {
            var e, f = a.on(this.process, this);
    ...
    +function(a) {
        ...
        var b = function(c, d) {
            this.options = a.extend({}, b.DEFAULTS, d),
                this.$window = a(window).on("scroll.bs.affix.data-api", a.on(this.checkPosition, this)).on("click.bs.affix.data-api", a.on(this.checkPositionWithEventLoop, this)),
                this.$element = a(c),
        ...
        b.RESET = "affix affix-top affix-bottom",
            ...
            b.prototype.checkPositionWithEventLoop = function() {
                setTimeout(a.on(this.checkPosition, this), 1)
            }
            ,
